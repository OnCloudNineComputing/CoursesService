...
class ProfessorCourseRDBService(RDBService):
    ...
    @classmethod
    def find_by_professor_name(cls, db_schema, table_name, name,
                               order_by=None, limit=None, offset=None,
                               field_list=None):

        template = {"professor": name}

        return cls.find_by_template(db_schema, table_name, template,
                                    order_by, limit, offset, field_list)

    @classmethod
    def delete_by_professor_name(cls, db_schema, table_name, name):
    ...
    @classmethod
    def update_by_professor_name(cls, db_schema, table_name, name, data):
