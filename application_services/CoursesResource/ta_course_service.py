...
from database_services.RDBServices.TACourseRDBService import TACourseRDBService


class TACourseResource(BaseRDBApplicationResource):
    ...
    def get_by_uni(cls, uni, order_by=None, limit=None, offset=None,
                   field_list=None):
        db_name, table_name = TACourseResource.get_data_resource_info()
        res = TACourseRDBService.find_by_uni(db_name, table_name, uni,
    ...
    def delete_by_uni(cls, uni):
        db_name, table_name = TACourseResource.get_data_resource_info()
        res = TACourseRDBService.delete_by_uni(db_name, table_name, uni)
        return res

    @classmethod
    def update_by_uni(cls, uni, data):
        db_name, table_name = TACourseResource.get_data_resource_info()
        res = TACourseRDBService.update_by_uni(db_name, table_name, uni, data)
        return res

    @classmethod
    def get_by_ta_name(cls, name, order_by=None, limit=None, offset=None,
                       field_list=None):
        db_name, table_name = TACourseResource.get_data_resource_info()
        res = TACourseRDBService.find_by_ta_name(db_name, table_name, name,
                                                 order_by, limit, offset,
                                                 field_list)
        return res

    @classmethod
    def delete_by_ta_name(cls, name):
        db_name, table_name = TACourseResource.get_data_resource_info()
        res = TACourseRDBService.delete_by_ta_name(db_name, table_name, name)
        return res

    @classmethod
    def update_by_ta_name(cls, name, data):
        db_name, table_name = TACourseResource.get_data_resource_info()
        res = TACourseRDBService.update_by_ta_name(db_name, table_name, name,
                                                   data)
        return res
    ...
    def get_by_course_id(cls, course_id, order_by=None, limit=None,
        ...
        db_name, table_name = TACourseResource.get_data_resource_info()
        res = TACourseRDBService.find_by_course_id(db_name, table_name,
                                                   course_id, order_by,
    ...
    def delete_by_course_id(cls, course_id):
        db_name, table_name = TACourseResource.get_data_resource_info()
        res = TACourseRDBService.delete_by_course_id(db_name, table_name,
                                                     course_id)
        return res
    ...
    def update_by_course_id(cls, course_id, data):
        db_name, table_name = TACourseResource.get_data_resource_info()
        res = TACourseRDBService.update_by_course_id(db_name, table_name,
                                                     course_id, data)
        return res
    ...
    def create(cls, data):
        ...
        res = TACourseRDBService.create(db_name, table_name, data)
        return res
    ...
    def get_data_resource_info(cls):
        return "cloud_computing_f21", "TA_course"
